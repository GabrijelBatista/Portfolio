            ...
            <div class="z-10 order-2 text-white lg:order-1 w-full h-full lg:w-3/5 flex items-center">
              <div class="min-w-full bg-gradient-to-r from-indigo-400 to-indigo-600 p-8 lg:pr-18 lg:pl-14 mx-2 lg:mx-0 h-full bg-white rounded-lg lg:rounded-none lg:rounded-l-lg shadow-2xl lg:shadow-none">
                <div class="flex flex-col space-y-4 lg:space-y-0 lg:flex-row lg:space-x-4">
                  ...
                  <div class="form-item w-full">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="h-5 w-5 inline-block m-2 bi bi-laptop-fill" viewBox="0 0 16 16">
              ...
              <div class="text-sm absolute bottom-1 left-6">
                <span class="text-white">Visit: <div class="inline-block underline">https://www.fpmoz.sum.ba</div></span>
              </div>
            </div>
          </a>
        </div>
            ...
            <div class="z-10 order-2 text-white lg:order-1 w-full h-full lg:w-3/5 flex items-center">
              <div class="min-w-full bg-gradient-to-r from-green-600 to-green-400 p-8 lg:pr-18 lg:pl-14 mx-2 lg:mx-0 h-full bg-white rounded-xl shadow-2xl">
                ...
                <div class="flex flex-col space-y-4 lg:space-y-0 lg:flex-row lg:space-x-4">
                  ...
                  <div class="form-item w-full">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 inline-block m-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div class="text-sm absolute bottom-1 right-6">
                <span class="text-white">Visit: <div class="inline-block underline">https://www.qsdbih.com</div></span>
              </div>
            </div>
          </a>
        </div>
